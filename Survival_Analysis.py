...
# line 35 and 39 
# to plot the  Time-line estimations plot for 2 groups on same graphs itself

##############################################################################
import pandas as pd
# Loading the the survival un-employment data
survival_unemp = pd.read_csv("E:\\Bokey\\Excelr Data\\Python Codes\\SurvivalAnalysis\\survival_unemployment1.csv")
survival_unemp.head()
