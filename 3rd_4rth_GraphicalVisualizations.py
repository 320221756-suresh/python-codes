...
mba = pd.read_csv("E:\\Bokey\\Excelr Data\\Python Codes\\Basic Statistics _ Visualizations\\mba.csv")
...
plt.bar(height = mba["gmat"], left = list(range(773))) # initializing the parameter 
